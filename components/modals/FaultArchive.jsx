// railway-app/components/modals/FaultArchive.jsx
import { X, ArrowLeft } from 'lucide-react';
import { formatFullDateTime } from '@/lib/utils';

export default function FaultArchive({
  faultArchiveDates, faultArchiveGrouped,
  selectedFaultDate, onSelectDate, onClose
}) {
  return (
              ...
              faultArchiveDates.map(date => (
                ...
                >
                  ...
                  <span className="text-xs font-bold opacity-60 group-hover:opacity-100">
                    {faultArchiveGrouped[date].length} ta nosozlik
                  </span>
                </button>
              ))
            )
